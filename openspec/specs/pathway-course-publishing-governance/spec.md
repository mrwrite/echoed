...
The system SHALL apply publish-readiness, deterministic ordering, learner availability, and staff preview rules to pathway, course, unit, and lesson publishing without creating a separate curriculum engine.
